...
<section class="shopping-cart">
    ...
    <div  class="box">
        ...
        <div class="sub-total"> sub-total : <span>Tk.5<?php echo $sub_total = ($fetch_cart['price'] * $fetch_cart['quantity']); ?>/-</span> </div>
    </div>
    <?php
    ...
    <div class="cart-total">
        <p>grand total : <span>Tk.5<?php echo $grand_total; ?>/-</span></p>
